          ...
          <div className="bg-emerald-800 shadow-md py-7 text-3xl text-white text-center font-playfair ">
            ...
            {loading ? (
              ...
              <div className="flex flex-col p-2">
                ...
                <div>Subtotal:   <span className="mr-2 text-xl text-slate-700">
                  ${subTotal}
                </span>
                </div>
                </div>
                <button className="flex justify-center text-white rounded-full py-3 text-lg bg-emerald-700 items-center">Checkout <i className="fa-solid fa-arrows-turn-right ml-2"></i></button>
      </div>
      </>      )}
          </div>
        </div>
